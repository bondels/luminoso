...
$sqlUltimos ="select * from datos where dato_comentario = 'el colorado' ORDER BY dato_id DESC limit 10 ";
...
CASE dato_beneficio
        WHEN 1 THEN '20% dcto clases'
        WHEN 2 THEN '50% Ticket'
        WHEN 3 THEN '20% Arriendo'
    END as beneficio
FROM datos
WHERE dato_comentario = 'el colorado'
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard Entel Nieve El Colorado</h1>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <a href="basecolorado.php">Descargar Base El Colorado</a>
                            </div>
                        </div>
